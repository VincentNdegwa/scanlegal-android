...
fun LoginScreen(
    ...
    fun launchGoogleSignIn(action: AuthViewModel.AuthAction) {
        if (activity == null) {
            Log.e("LoginScreen", "Google sign-in failed: not an Activity context")
            scope.launch {
    ...
    LaunchedEffect(errorMessage) {
        errorMessage?.let {
            Log.e("LoginScreen", "Auth error: $it")
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Sign in to access your legal documents",
                ...
                GoogleAuthButton(
                    ...
                    onClick = { launchGoogleSignIn(AuthViewModel.AuthAction.LOGIN) },
                    enabled = !isLoading
                )
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
                    TextButton(onClick = { forgotPassword() }, enabled = !isLoading) {
